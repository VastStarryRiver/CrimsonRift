...
const managerConfig = {
    DATA_FILE_MD5: '4fc10ee9121e960d',
    CODE_FILE_MD5: '2d138cca7ded71aa',
    GAME_NAME: 'webgl',
    APPID: 'wx7b87e25d2ff45d15',
    DATA_FILE_SIZE: '25023652',
    OPT_DATA_FILE_SIZE: '$OPT_DATA_FILE_SIZE',
    DATA_CDN: 'https://139.155.11.195/svn/VastStarryRiver/WeChatMiniGame/CrimsonRift',
    // 资源包是否作为小游戏分包加载
