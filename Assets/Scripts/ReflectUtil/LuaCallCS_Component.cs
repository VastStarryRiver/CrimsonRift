...
public static partial class LuaCallCS
{
    ...
    public static void AddInputFieldListener(UnityEngine.Object obj, string childPath, LuaFunction luaFunc)
    {
        Transform trans = GetTransform(obj, childPath);

        UIInputField inputField = trans.GetComponent<UIInputField>();
        ...
        inputField.AddOnValueChangedListener(luaFunc);
    }
}