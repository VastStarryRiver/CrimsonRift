...
public class LoopScrollList : ScrollRect
{
    ...
    public void Init(int type, int showCount, int totalCount, LuaFunction updateFunc, LuaFunction callBack = null)
    {
        m_type = type;
        ...
        for (int i = 0; i < showCount; i++)
        {
            ...
            m_updateFunc.Call(i, (RectTransform)item);
        ...
        for (int i = 1; i < m_totalCount - 1; i++)
        {
            ...
            if (min2 >= min && min2 <= min + 0.1f)
            {
                if (m_index1 != i)
                {
                    ...
                    m_updateFunc.Call(i, (RectTransform)item2);
    ...
    public void UpdateAllItem()
    {
        for (int i = 0; i < content.childCount; i++)
        {
            ...
            m_updateFunc.Call(index, (RectTransform)item);
