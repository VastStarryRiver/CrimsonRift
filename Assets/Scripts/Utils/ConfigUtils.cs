...
public class ConfigUtils
{
    ...
    public const bool m_isUpdate = false;
#else
    public static string m_localRootPath = Application.persistentDataPath + "/";
    public const bool m_isUpdate = true;
#endif
    ...
    public readonly static string m_luaPath = m_localRootPath + "Assets/GameAssets/Lua";
    public readonly static string m_bundlePath = m_localRootPath + "Bundles";
    ...
    public static void GetConfigData(string configName, string index, string name = "", LuaFunction callBack = null)
    {
        ...
        AddressablesManager.Instance.AsyncLoadBinAsset(key, (data) => {
            ...
            if (config.ContainsKey(index))
            {
                ...
                {
                    callBack?.Call(config[index]);
                    return;
                }
                else if (config[index].ContainsKey(name))
                {
                    callBack?.Call(config[index][name]);
                    return;
                }
            }
