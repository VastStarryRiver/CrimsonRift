...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineSkinWeightsWrap
    {
		public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginClassRegister(typeof(UnityEngine.SkinWeights), L, null, 6, 0, 0);

            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "None", UnityEngine.SkinWeights.None);
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
                ...
                {
                    translator.PushUnityEngineSkinWeights(L, UnityEngine.SkinWeights.None);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "OneBone"))
                {
