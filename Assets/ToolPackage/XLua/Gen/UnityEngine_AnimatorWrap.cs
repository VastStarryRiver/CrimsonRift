...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAnimatorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 58, 45, 20);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetUpdateFrequencyMode", _m_SetUpdateFrequencyMode);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetUpdateFrequency", _m_GetUpdateFrequency);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetUpdateFrequencyMode", _m_GetUpdateFrequencyMode);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetUpdateFrequencyMode(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.AnimatorUpdateFrequencyMode>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    UnityEngine.AnimatorUpdateFrequencyMode _mode;translator.Get(L, 2, out _mode);
                    float _frequency = (float)LuaAPI.lua_tonumber(L, 3);
                    
                    gen_to_be_invoked.SetUpdateFrequencyMode( _mode, _frequency );
                    
                    
                    
                    return 0;
                }
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.AnimatorUpdateFrequencyMode>(L, 2)) 
                {
                    UnityEngine.AnimatorUpdateFrequencyMode _mode;translator.Get(L, 2, out _mode);
                    
                    gen_to_be_invoked.SetUpdateFrequencyMode( _mode );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Animator.SetUpdateFrequencyMode!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetUpdateFrequency(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetUpdateFrequency(  );
                        LuaAPI.lua_pushnumber(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetUpdateFrequencyMode(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetUpdateFrequencyMode(  );
                        translator.Push(L, gen_ret);
