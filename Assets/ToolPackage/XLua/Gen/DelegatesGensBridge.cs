...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public bool __Gen_Delegate_Imp6(float p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<UnityEngine.Vector2>(__Gen_Delegate_Imp4);
			}
		    ...
		    if (type == typeof(System.Func<float, bool>))
			{
			    return new System.Func<float, bool>(__Gen_Delegate_Imp6);
			}
