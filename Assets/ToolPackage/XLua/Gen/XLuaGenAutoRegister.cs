...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit1(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(UIMask), UIMaskWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(UIButton), UIButtonWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(UIInputField), UIInputFieldWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(LuaCallCS), LuaCallCSWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(PrefabInstance), PrefabInstanceWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(SdkMsgManager), SdkMsgManagerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(DataUtilityManager), DataUtilityManagerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(DebugLogTool), DebugLogToolWrap.__Register);
            ...
            translator.DelayWrapLoader(typeof(LoopScrollList), LoopScrollListWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(PolygonImage), PolygonImageWrap.__Register);
