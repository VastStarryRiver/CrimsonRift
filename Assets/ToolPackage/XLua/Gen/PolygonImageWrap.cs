...
namespace XLua.CSObjectWrap
{
    ...
    public class PolygonImageWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(PolygonImage);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to PolygonImage constructor!");
        ...
        static int _m_IsRaycastLocationValid(RealStatePtr L)
        {
		    try {
                ...
                PolygonImage gen_to_be_invoked = (PolygonImage)translator.FastGetCSObj(L, 1);
