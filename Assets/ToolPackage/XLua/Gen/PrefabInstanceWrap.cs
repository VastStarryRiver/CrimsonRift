...
namespace XLua.CSObjectWrap
{
    ...
    public class PrefabInstanceWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(PrefabInstance);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new PrefabInstance();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to PrefabInstance constructor!");
        ...
        static int _m_GetLuaTable(RealStatePtr L)
        {
		    try {
                ...
                PrefabInstance gen_to_be_invoked = (PrefabInstance)translator.FastGetCSObj(L, 1);
