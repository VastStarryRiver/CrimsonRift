...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineShaderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 33, 5, 3);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "WarmupAllShadersAsync", _m_WarmupAllShadersAsync_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "WarmupAllShadersWait", _m_WarmupAllShadersWait_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetWarmupProgress", _m_GetWarmupProgress_xlua_st_);
        ...
        static int _m_WarmupAllShaders_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    bool _alwaysIncludedShaders = LuaAPI.lua_toboolean(L, 1);
                    
                    UnityEngine.Shader.WarmupAllShaders( _alwaysIncludedShaders );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Shader.WarmupAllShaders!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_WarmupAllShadersAsync_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 1)) 
                {
                    bool _alwaysIncludedShaders = LuaAPI.lua_toboolean(L, 1);
                        ...
                        var gen_ret = UnityEngine.Shader.WarmupAllShadersAsync( _alwaysIncludedShaders );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 0) 
                {
                        ...
                        var gen_ret = UnityEngine.Shader.WarmupAllShadersAsync(  );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Shader.WarmupAllShadersAsync!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_WarmupAllShadersWait_xlua_st_(RealStatePtr L)
        {
		    try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetWarmupProgress_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = UnityEngine.Shader.GetWarmupProgress(  );
