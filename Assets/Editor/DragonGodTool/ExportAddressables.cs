...
public class ExportAddressables
{
    ...
    [MenuItem("GodDragonTool/Addressables/BuildAddressables_WeixinMiniGame", false, 1)]
    public static void BuildAddressables_WeixinMiniGame()
    {
        SetProfileValue("WeixinMiniGame");
        BuildAddressables("WeixinMiniGame");
    }
